...
files = [
    ...
    r"agent\graph.py",
    r"agent\state.py",
    r"agent\planning\brief.py",
    r"agent\planning\compose.py",
    r"agent\planning\evidence.py",
    r"agent\planning\legs.py",
    r"agent\planning\models.py",
    r"agent\planning\prompts.py",
    r"agent\planning\quality.py",
    r"agent\planning\renderer.py",
    r"tools\place_coordinates.py",
    r"config.py",
    r"app.py",
    ...
    "eval/constraint_judge.py",
    "eval/merge_ablation.py",
    "eval/paper_eval_analysis.py",
    "eval/tests/test_dataset_integrity.py",
    "eval/tests/test_paper_eval_pipeline.py",
