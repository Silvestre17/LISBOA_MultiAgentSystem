...
@contextmanager
def temporary_lisboa_provider(provider: str | None):
    """Temporarily override the global provider family used by LISBOA agents."""
...
def run_ablation(
    ...
    Args:
        ...
        lisboa_provider: Optional provider-family override for the LISBOA multi-agent arm.
    ...
    with tracing_project_override(ablation_langsmith_project):
        ...
        with temporary_lisboa_provider(lisboa_provider) as active_lisboa_provider:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional provider-family override for the LISBOA multi-agent arm (azure, openai, lmstudio).",
    )
    parser.add_argument(
        "--judge-provider",
        type=str,
