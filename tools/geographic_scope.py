...
#   Lisbon Metropolitan Area scope. They live in tools/ and use only the
#   standard library, so tool modules (location_resolver, carris_api) can
#   import them without importing the agent package and its LLM stack.
# ==========================================================================
    ...
    *,
    ...
    if is_pt:
        ...
        return "\n".join(
            [
                ...
                "",
                "💡 **Âmbito suportado:**",
                "- 🌤️ **Meteorologia:** previsão e avisos para Lisboa",
                ...
                "- 🗺️ **Planeamento:** roteiros e percursos dentro de Lisboa/AML",
    ...
    return "\n".join(
        [
            ...
            "",
            "💡 **Supported scope:**",
            "- 🌤️ **Weather:** Lisbon forecasts and warnings",
            ...
            "- 🗺️ **Planning:** itineraries and routes inside Lisbon/AML",
