...
METRO_STATION_IDS = {
    ...
    "santa apolónia": "SP", "santa apolonia": "SP",
    "terreiro do paço": "TP", "terreiro do paco": "TP",
    "baixa-chiado": "BC", "baixa chiado": "BC",
    "restauradores": "RE", "avenida": "AV", "parque": "PA",
    "são sebastião": "SS", "sao sebastiao": "SS", "s. sebastião": "SS",
    "praça de espanha": "PE", "praca de espanha": "PE",
    "jardim zoológico": "JZ", "jardim zoologico": "JZ",
    "laranjeiras": "LA", "alto dos moinhos": "AH",
    "colégio militar": "CM", "colegio militar": "CM", "colégio militar/luz": "CM",
    "carnide": "CA", "pontinha": "PO", "alfornelos": "AF",
    "amadora este": "AS", "reboleira": "RB",
    "cais do sodré": "CS", "cais do sodre": "CS",
    "rossio": "RO", "martim moniz": "MM", "intendente": "IN",
    "anjos": "AN", "arroios": "AR", "alameda": "AM", "areeiro": "AE",
    "roma": "RM", "alvalade": "AL", "telheiras": "TE",
    "olaias": "OL", "bela vista": "BV", "chelas": "CH", "olivais": "OS",
    "cabo ruivo": "CR", "oriente": "OR", "moscavide": "MO",
    "encarnação": "EN", "encarnacao": "EN", "aeroporto": "AP",
}
...
METRO_DESTINATIONS = {
    "33": "Reboleira", "34": "Amadora Este", "35": "Pontinha",
    "36": "Colégio Militar/Luz", "37": "Laranjeiras", "38": "São Sebastião",
    "39": "Avenida", "40": "Baixa-Chiado", "41": "Terreiro do Paço",
    "42": "Santa Apolónia", "43": "Odivelas", "44": "Lumiar",
    "45": "Campo Grande", "46": "Campo Pequeno", "48": "Rato",
    "50": "Telheiras", "51": "Alvalade", "52": "Alameda",
    "53": "Martim Moniz", "54": "Cais do Sodré", "56": "Bela Vista",
    "57": "Chelas", "59": "Moscavide", "60": "Aeroporto",
}

# Lisbon Landmarks → Nearest Metro Station Mapping
LISBON_LANDMARKS = {
    "colombo": {"name": "Centro Comercial Colombo", "metro": "colégio militar/luz", "line": "azul", "description": "Largest shopping center in the Iberian Peninsula"},
    "vasco da gama": {"name": "Centro Comercial Vasco da Gama", "metro": "oriente", "line": "vermelha", "description": "Shopping center at Parque das Nações"},
    "el corte inglés": {"name": "El Corte Inglés", "metro": "são sebastião", "line": "azul/vermelha", "description": "Department store near Marquês roundabout"},
    "amoreiras": {"name": "Amoreiras Shopping Center", "metro": "marquês de pombal", "line": "amarela/azul", "description": "Shopping center at Amoreiras (15 min walk from metro)"},
    "aeroporto": {"name": "Aeroporto Humberto Delgado", "metro": "aeroporto", "line": "vermelha", "description": "Lisbon Airport"},
    "oceanário": {"name": "Oceanário de Lisboa", "metro": "oriente", "line": "vermelha", "description": "Lisbon Oceanarium at Parque das Nações"},
    "parque das nações": {"name": "Parque das Nações", "metro": "oriente", "line": "vermelha", "description": "Expo'98 area"},
    "jardim zoológico": {"name": "Jardim Zoológico de Lisboa", "metro": "jardim zoológico", "line": "azul", "description": "Lisbon Zoo"},
    "gulbenkian": {"name": "Fundação Calouste Gulbenkian", "metro": "são sebastião", "line": "azul/vermelha", "description": "Gulbenkian Museum and Gardens"},
    "belém": {"name": "Belém", "metro": None, "alternative": "Tram 15E (Praça da Figueira) or CP Train (from Cais do Sodré)", "description": "Jerónimos Monastery, Belém Tower, Padrão dos Descobrimentos"},
    "torre de belém": {"name": "Torre de Belém", "metro": None, "alternative": "Tram 15E or CP Train to Belém", "description": "UNESCO Monument"},
